...
build {
  ...
  # provisioner "file" {
  #   source = "file/etc/systemd/system/kubelet.service.d/20-worker-service-manager.conf"
  #   destination = "/etc/systemd/system/kubelet.service.d/20-worker-service-manager.conf"
  # }
  provisioner "file" {
  ...
  provisioner "shell" {
    inline = [
      ...
      # "chown root:root /etc/systemd/system/kubelet.service.d/20-worker-service-manager.conf",
      ...
      # "chmod 400 /etc/systemd/system/kubelet.service.d/20-worker-service-manager.conf",
