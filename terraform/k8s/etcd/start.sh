...
incus exec --project k8s homelab:etcd-1 -- kubeadm init phase etcd local --config=/root/kubeadmcfg.yaml
incus exec --project k8s homelab:etcd-1 -- systemctl restart kubelet

incus exec --project k8s homelab:etcd-2 -- kubeadm init phase etcd local --config=/root/kubeadmcfg.yaml
incus exec --project k8s homelab:etcd-2 -- systemctl restart kubelet

incus exec --project k8s homelab:etcd-3 -- kubeadm init phase etcd local --config=/root/kubeadmcfg.yaml
